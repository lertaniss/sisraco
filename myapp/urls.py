...
urlpatterns = [
    ...
    url(r'^newOnibus', views.criarOnibus, name="Novo Onibus"),
    url(r'^tb_paradas', views.ParadasView.as_view(), name="Lista de Paradas"),
    url(r'^tb_rotas', views.RotasView.as_view(), name='lista de Rotas'),
    ...
    path('editarParada/<int:id>', views.editarParada, name='Editar parada'),
    url(r'^editarOnibus', views.editarOnibus, name='editar onibus'),
    url(r'^verRota', views.verRota, name='verRota'),
]
